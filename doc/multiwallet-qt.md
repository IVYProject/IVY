...
In order to support loading of multiple wallets in ivy-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ivy.cpp.
...
Changes to ivy.cpp
----------------------
ivy.cpp is the entry point into ivy-qt, and as such, will require some minor modifications to provide hooks for
