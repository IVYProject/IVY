...
This mechanism has been integrated into Bitcore-Node-IVY which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/IVY-Project/insight-api-ivy#web-socket-api](https://github.com/IVY-Project/insight-api-ivy#web-socket-api) 
* API: [https://github.com/IVY-Project/insight-api-ivy#swifttx-transactions](https://github.com/IVY-Project/insight-api-ivy#swifttx-transactions) 
...
By default, the IVY Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the IVY Core daemon:
