...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ivy features */
        {"ivy", "masternode", &masternode, true, true, false},
        {"ivy", "masternodelist", &masternodelist, true, true, false},
        {"ivy", "mnbudget", &mnbudget, true, true, false},
        {"ivy", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"ivy", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ivy", "mnsync", &mnsync, true, true, false},
        {"ivy", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"ivy", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ivyd, or the -server option to ivy-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ivy-cli " + methodname + " " + args + "\n";
}
