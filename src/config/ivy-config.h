/* src/config/ivy-config.h.  Generated from ivy-config.h.in by configure.  */
/* src/config/ivy-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.ivy.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Ivy Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ivy Core 0.4.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ivy"
