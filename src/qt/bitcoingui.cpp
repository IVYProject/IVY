                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("IVY Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a IVY address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ivy: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About IVY Core"), this);
    aboutAction->setStatusTip(tr("Show information about IVY Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for IVY"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your IVY addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified IVY addresses"));
    ...
    openAction->setStatusTip(tr("Open a IVY: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the IVY Core help message to get a list with possible IVY command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("IVY Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to IVY network", "", count));
}
...
{
    QString strTitle = tr("IVY Core"); // default title
