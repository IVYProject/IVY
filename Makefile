...
pkgdatadir = $(datadir)/ivy
pkgincludedir = $(includedir)/ivy
pkglibdir = $(libdir)/ivy
pkglibexecdir = $(libexecdir)/ivy
...
CONFIG_HEADER = $(top_builddir)/src/config/ivy-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/ivy-config.h.in \
...
ACLOCAL = ${SHELL} /home/drakelv/ivy/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/drakelv/ivy/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/drakelv/ivy/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/drakelv/ivy/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/drakelv/ivy/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = ivy
PACKAGE_BUGREPORT = www.ivy.org
PACKAGE_NAME = Ivy Core
PACKAGE_STRING = Ivy Core 0.4.0
PACKAGE_TARNAME = ivy
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/drakelv/ivy
abs_srcdir = /home/drakelv/ivy
abs_top_builddir = /home/drakelv/ivy
abs_top_srcdir = /home/drakelv/ivy
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/drakelv/ivy/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/ivyd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/ivy-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/ivy-cli$(EXEEXT)
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_ivy_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_ivy_coverage.info test_ivy.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/IVY-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/ivy-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/ivy-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/ivy-config.h
$(top_srcdir)/src/config/ivy-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/ivy-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/IVY-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/IVY-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/IVY-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_ivy.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_ivy -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_ivy_filtered.info: test_ivy.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_ivy_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_ivy_coverage.info: baseline_filtered_combined.info test_ivy_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_ivy_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_ivy_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_ivy_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_ivy.coverage/.dirstamp:  test_ivy_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_ivy.coverage/.dirstamp total.coverage/.dirstamp

# IVY: disable the outdated comparison tool test
...
clean-local:
	rm -rf test_ivy.coverage/ total.coverage/ $(OSX_APP)
