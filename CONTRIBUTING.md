Contributing to IVY Core
============================

The IVY Core project operates an open contributor model where anyone is
...
The following applies to code changes to the IVY Core project, and is not to be
confused with overall IVY Network Protocol consensus changes.

Whether a pull request is merged into IVY Core rests with the project merge
...
Patches that change IVY consensus rules are considerably more involved than
...
Where a patch set proposes to change the IVY consensus, it must have been
...
The project leader is the release manager for each IVY Core release.
