...
This means one can have an always-on ivyd instance running, and another local ivyd/ivy-qt instance which connects to this node and receives blocks from it.
