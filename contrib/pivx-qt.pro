...
RESOURCES += src/qt/ivy.qrc src/qt/ivy_locale.qrc

TRANSLATIONS += src/qt/locale/ivy_bg.ts \
                src/qt/locale/ivy_de.ts \
                src/qt/locale/ivy_en.ts \
                src/qt/locale/ivy_es.ts \
                src/qt/locale/ivy_fi.ts \
                src/qt/locale/ivy_fr.ts \
                src/qt/locale/ivy_it.ts \
                src/qt/locale/ivy_ja.ts \
                src/qt/locale/ivy_pl.ts \
                src/qt/locale/ivy_pt.ts \
                src/qt/locale/ivy_ru.ts \
                src/qt/locale/ivy_sk.ts \
                src/qt/locale/ivy_sv.ts \
                src/qt/locale/ivy_vi.ts \
                src/qt/locale/ivy_zh_CN.ts \
                src/qt/locale/ivy_zh_TW.ts
